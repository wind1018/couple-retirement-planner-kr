...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'font-heading text-lg leading-snug font-extrabold tracking-tight text-slate-950 group-data-[size=sm]/card:text-base group-data-[size=sm]/card:font-bold',
        className,
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('min-w-0 max-w-full px-(--card-spacing)', className)}
      {...props}
    />
  );
}
